...
<cfoutput>
	<div class="art-block clearfix">
		<div class="art-blockheader">
			<h3 class="t">Copying Workshop/Event: #Session.UserSuppliedInfo.ShortTitle#</h3>
		</div>
		<div class="art-blockcontent">
			<div class="alert-box notice">Please click the button below to copy this event to a new event. </div>
			<hr>
			<uForm:form action="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.copypriorevent&compactDisplay=false&EventID=#URL.EventID#&EventStatus=CopyEvent" method="Post" id="CopyEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				submitValue="Copy This Event" loadValidation="true" loadMaskUI="true" loadDateUI="true" loadTimeUI="true">
				<input type="hidden" name="SiteID" value="#rc.$.siteConfig('siteID')#">
				<input type="hidden" name="formSubmit" value="true">
				<input type="hidden" name="PerformAction" value="CopyEvent">
