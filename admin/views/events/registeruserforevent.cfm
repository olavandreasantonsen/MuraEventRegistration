		...
		<cfswitch expression="#URL.EventStatus#">
					<cfcase value="CorporationSelected">
						<cfif Session.UserSuppliedInfo.EventRegistration.NumberOfUserAccountsWithinOrganization EQ 0>
							<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.registeruserforevent&EventID=#URL.EventID#&EventStatus=RegisterParticipantsToEvent" addtoken="true">
						<cfelse>
							<div class="art-block clearfix">
								<div class="art-blockheader">
									<h3 class="t">Registering Participant for Workshop/Event: #Session.UserSuppliedInfo.PickedEvent.ShortTitle#</h3>
								...
								<div class="art-blockcontent">
									...
									<hr>
									<Form Method="Post" Action="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.registeruserforevent&EventID=#URL.EventID#&EventStatus=RegisterParticipantsToEvent" id="RegisterParticipants">
					...
					<cfcase value="RegisterParticipantsToEvent">
						<div class="art-block clearfix">
							...
							<div class="art-blockcontent">
								...
								<hr>
								<uForm:form action="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.registeruserforevent&EventID=#URL.EventID#&EventStatus=RegisterParticipantsToEvent" method="Post" id="RegisterParticipants" errors="#Session.FormErrors#" errorMessagePlacement="both"
									commonassetsPath="/plugins/EventRegistration/library/uniForm/" showCancel="yes" cancelValue="<--- Return to Menu" cancelName="cancelButton"
									cancelAction="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events&compactDisplay=false"
