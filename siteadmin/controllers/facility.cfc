<cfcomponent output="false" persistent="false" accessors="true">
	...
	<cffunction name="editfacility" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Main Menu">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.default" addtoken="false">
			</cfif>
			...
			<cfif FORM.Active EQ "----">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.editfacility&FormRetry=True&FacilityID=#URL.FacilityID#" addtoken="false">
			</cfif>
			...
			<cfelse>
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.default&UserAction=InformationUpdated&Successful=True" addtoken="false">
			</cfif>
		</cfif>
	</cffunction>
	...
	<cffunction name="editfacilityroom" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Main Menu">
				...
				<cfset temp = StructDelete(Session, "FormInput")>
				<cfif isDefined("Session.FormInput")><cfset temp = StructDelete(Session, "FormInput")></cfif>
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.editfacility&FacilityID=#URL.FacilityID#" addtoken="false">
			</cfif>
			...
			<cfif FORM.Active EQ "----">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.editfacilityroom&FormRetry=True&FacilityID=#URL.FacilityID#&FacilityRoomID=#URL.FacilityRoomID#" addtoken="false">
			</cfif>
			...
			<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.editfacility&UserAction=RoomUpdated&Successful=True&FacilityID=#URL.FacilityID#" addtoken="false">
		</cfif>
	</cffunction>
	...
	<cffunction name="addfacilityroom" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.editfacility&UserAction=RoomCreated&Successful=True&FacilityID=#URL.FacilityID#" addtoken="false">
		</cfif>
	</cffunction>
	...
	<cffunction name="addfacility" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.Active EQ "----">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:facility.addfacility&FormRetry=True" addtoken="false">
			</cfif>
