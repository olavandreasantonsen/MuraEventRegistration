...
<cfif Session.UserSuppliedInfo.WebinarEvent EQ 1><cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.addevent_step4&PerformAction=Step4&SiteID=#rc.$.siteConfig('siteID')#" addtoken="false"></cfif>
	...
	<div class="art-block clearfix">
		...
		<div class="art-blockcontent">
			...
			<uForm:form action="" method="Post" id="AddEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				cancelAction="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.addevent_step2&PerformAction=Step2&compactDisplay=false"
