	...
	<cffunction name="addorganization" returntype="any" output="false">
		...
		<cfif isDefined("FORM.formSubmit") and isDefined("FORM.PerformAction")>
			...
			<cfif ArrayLen(Session.FormErrors)>
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:membership.addorganization&SiteID=#rc.$.siteConfig('siteID')#" addtoken="false">
			<cfelse>
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:membership&UserAction=AddedOrganization&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
			</cfif>
	...
	<cffunction name="updateorganization_deactivate" returntype="any" output="false">
		...
		<cfif isDefined("FORM.formSubmit") and isDefined("FORM.PerformAction")>
			<cfif isNumeric(FORM.OrgID)>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:membership&UserAction=DeactivatedOrganization&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
			</cfif>
		</cfif>
	</cffunction>
	...
	<cffunction name="updateorganization_activate" returntype="any" output="false">
		...
		<cfif isDefined("FORM.formSubmit") and isDefined("FORM.PerformAction")>
			<cfif isNumeric(FORM.OrgID)>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:membership&UserAction=ActivatedOrganization&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
			</cfif>
		</cfif>
	</cffunction>
	...
	<cffunction name="updateorganization" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit") and isDefined("FORM.PerformAction")>
			...
			<cfelse>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:membership&UserAction=UpdatedOrganization&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
			</cfif>
		</cfif>
	</cffunction>
