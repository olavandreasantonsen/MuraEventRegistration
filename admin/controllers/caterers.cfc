...
<cfcomponent extends="controller" output="false" persistent="false" accessors="true">
	...
	<cffunction name="addcaterer" returntype="any" output="true">
		<cfargument name="rc" required="true" type="struct" default="#StructNew()#">
		...
		<cfif isDefined("FORM.formSubmit") and not isDefined("FORM.ReSubmit")>
			<cflock timeout="60" scope="SESSION" type="Exclusive">
				...
				<cfset Session.UserSuppliedInfo.PaymentTerms = #FORM.PaymentTerms#>
				<cfset Session.UserSuppliedInfo.DeliveryInfo = #FORM.DeliveryInfo#>
				<cfset Session.UserSuppliedInfo.GuaranteeInfo = #FORM.GuaranteeInformation#>
				<cfset Session.UserSuppliedInfo.AdditionalNotes = #FORM.AdditionalNotes#>
			...
			<cfif AddressGeoCoded[1].ErrorMessage NEQ "OK">
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:caterers.addcaterer&PerformAction=ReEnterAddress&SiteID=#rc.$.siteConfig('siteID')#" addtoken="false">
			<cfelse>
				<cfset CombinedPhysicalAddress = #AddressGeoCoded[1].AddressStreetNumber# & " " & #AddressGeoCoded[1].AddressStreetNameShort#>

				<cfquery name="insertNewCaterer" result="insertNewCaterer" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
					Insert into eCaterers(FacilityName, PhysicalAddress, PhysicalCity, PhysicalState, PhysicalZipCode, dateCreated, lastUpdated, lastUpdateBy, Site_ID)
					Values("#FORM.FacilityName#", "#Variables.CombinedPhysicalAddress#", "#Trim(Variables.AddressGeoCoded[1].AddressCityName)#", "#Trim(Variables.AddressGeoCoded[1].AddressStateNameShort)#", "#Trim(Variables.AddressGeoCoded[1].AddressZipCode)#", #Now()#, #Now()#, "#rc.$.currentUser('userName')#", "#rc.$.siteConfig('siteID')#")
				</cfquery>

				<cfset newRecordID = insertNewCaterer.generatedkey>
				...
				<cfif LEN(FORM.PaymentTerms)>
					<cfquery name="updateVendorContactEmail" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
						Update eCaterers
						Set PaymentTerms = <cfqueryparam value="#FORM.PaymentTerms#" cfsqltype="cf_sql_varchar">
						Where TContent_ID = <cfqueryparam value="#variables.newRecordID#" cfsqltype="cf_sql_integer"> and Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar">
					</cfquery>
				</cfif>
				<cfif LEN(FORM.DeliveryInfo)>
					<cfquery name="updateVendorContactEmail" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
						Update eCaterers
						Set DeliveryInfo = <cfqueryparam value="#FORM.DeliveryInfo#" cfsqltype="cf_sql_varchar">
						Where TContent_ID = <cfqueryparam value="#variables.newRecordID#" cfsqltype="cf_sql_integer"> and Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar">
					</cfquery>
				</cfif>
				<cfif LEN(FORM.GuaranteeInformation)>
					<cfquery name="updateVendorContactEmail" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
						Update eCaterers
						Set GuaranteeInformation = <cfqueryparam value="#FORM.GuaranteeInformation#" cfsqltype="cf_sql_varchar">
						Where TContent_ID = <cfqueryparam value="#variables.newRecordID#" cfsqltype="cf_sql_integer"> and Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar">
					</cfquery>
				</cfif>
				<cfif LEN(FORM.AdditionalNotes)>
					<cfquery name="updateVendorContactEmail" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
						Update eCaterers
						Set AdditionalNotes = <cfqueryparam value="#FORM.AdditionalNotes#" cfsqltype="cf_sql_varchar">
						Where TContent_ID = <cfqueryparam value="#variables.newRecordID#" cfsqltype="cf_sql_integer"> and Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar">
					</cfquery>
				</cfif>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:caterers&UserAction=AddedCaterers&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
			</cfif>
		<cfelseif isDefined("FORM.formSubmit") and isDefined("FORM.ReSubmit")>
			<cflock timeout="60" scope="SESSION" type="Exclusive">
				...
				<cfset Session.UserSuppliedInfo.PhysicalState = #FORM.PhysicalState#>
				<cfset Session.UserSuppliedInfo.PhysicalZipCode = #FORM.PhysicalZipCode#>
				<cfset Session.UserSuppliedInfo.Active = #FORM.Active#>
				<cfset Session.UserSuppliedInfo.PrimaryVoiceNumber = #FORM.PrimaryVoiceNumber#>
				<cfset Session.UserSuppliedInfo.BusinessWebsite = #FORM.BusinessWebsite#>
				<cfset Session.UserSuppliedInfo.PaymentTerms = #FORM.PaymentTerms#>
				<cfset Session.UserSuppliedInfo.DeliveryInfo = #FORM.DeliveryInfo#>
			...
			<cfelse>
				...
				<cfquery name="insertNewCaterer" result="insertNewCaterer" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
					Insert into eFacility(FacilityName, PhysicalAddress, PhysicalCity, PhysicalState, PhysicalZipCode, dateCreated, lastUpdated, lastUpdateBy, Site_ID)
					Values("#FORM.FacilityName#", "#Variables.CombinedPhysicalAddress#", "#Trim(Variables.AddressGeoCoded[1].AddressCityName)#", "#Trim(Variables.AddressGeoCoded[1].AddressStateNameShort)#", "#Trim(Variables.AddressGeoCoded[1].AddressZipCode)#", #Now()#, #Now()#, "#rc.$.currentUser('userName')#", "#rc.$.siteConfig('siteID')#")
				</cfquery>
	...
	<cffunction name="updatecaterer" returntype="any" output="true">
		<cfargument name="rc" required="true" type="struct" default="#StructNew()#">
			...
			<cfif isDefined("URL.PerformAction")>
				<cfswitch expression="#URL.PerformAction#">
					<cfcase value="Edit">
						...
						<cfparam name="UpdateInfo.PaymentTermsUpdated" type="boolean" default="0">
						<cfparam name="UpdateInfo.DeliveryInfoUpdated" type="boolean" default="0">
						<cfparam name="UpdateInfo.GuaranteeInfoUpdated" type="boolean" default="0">
						<cfparam name="UpdateInfo.AdditionalInfoUpdated" type="boolean" default="0">
						...
						<cfif getSelectedFacility.PhysicalAddress NEQ Form.PhysicalAddress><cfset UpdateInfo.AddressUpdated = 1></cfif>
						<cfif getSelectedFacility.PhysicalCity NEQ Form.PhysicalCity><cfset UpdateInfo.CityUpdated = 1></cfif>
						<cfif getSelectedFacility.PhysicalState NEQ Form.PhysicalState><cfset UpdateInfo.StateUpdated = 1></cfif>
						<cfif getSelectedFacility.PhysicalZipCode NEQ Form.PhysicalZipCode><cfset UpdateInfo.ZipCodeUpdated = 1></cfif>
						...
						<cfif getSelectedFacility.PaymentTerms NEQ Form.PaymentTerms><cfset UpdateInfo.PaymentTermsUpdated = 1></cfif>
						<cfif getSelectedFacility.DeliveryInfo NEQ Form.DeliveryInfo><cfset UpdateInfo.DeliveryInfoUpdated = 1></cfif>
						<cfif getSelectedFacility.GuaranteeInformation NEQ Form.GuaranteeInformation><cfset UpdateInfo.GuaranteeInfoUpdated = 1></cfif>
						<cfif getSelectedFacility.AdditionalNotes NEQ Form.AdditionalNotes><cfset UpdateInfo.AdditionalInfoUpdated = 1></cfif>
						...
						<cfif getSelectedFacility.Active NEQ Form.Active><cfset UpdateInfo.ActiveUpdated = 1></cfif>
						...
						<cfif UpdateInfo.AddressUpdated EQ 1 OR UpdateInfo.CityUpdated EQ 1 OR UpdateInfo.StateUpdated EQ 1 OR UpdateInfo.ZipCodeUpdated EQ 1>
							...
							<cfif AddressGeoCoded[1].ErrorMessage NEQ "OK">
								...
								<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:caterers.updatecaterer&PerformAction=ReEnterAddress&SiteID=#rc.$.siteConfig('siteID')#&RecNo=#getSelectedFacility.TContent_ID#" addtoken="false">
							<cfelse>
								<cfset CombinedPhysicalAddress = #AddressGeoCoded[1].AddressStreetNumber# & " " & #AddressGeoCoded[1].AddressStreetNameShort#>
								<cfquery name="updateFacilityAddress" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
									...
									Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
										TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
								</cfquery>
							</cfif>
						</cfif>
						...
						<cfif UpdateInfo.NameUpdated EQ 1>
							<cfquery name="updateFacilityName" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set FacilityName = <cfqueryparam value="#Trim(Form.FacilityName)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
						...
						<cfif UpdateInfo.VoiceNumberUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set PrimaryVoiceNumber = <cfqueryparam value="#Trim(Form.PrimaryVoiceNumber)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.PaymentTermsUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set PaymentTerms = <cfqueryparam value="#Trim(Form.PaymentTerms)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.DeliveryInfoUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set DeliveryInfo = <cfqueryparam value="#Trim(Form.DeliveryInfo)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.GuaranteeInfoUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set GuaranteeInformation = <cfqueryparam value="#Trim(Form.GuaranteeInformation)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.AdditionalInfoUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set AdditionalNotes = <cfqueryparam value="#Trim(Form.AdditionalNotes)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.ContactNameUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set ContactName = <cfqueryparam value="#Trim(Form.ContactName)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.ContactPhoneUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set ContactPhoneNumber = <cfqueryparam value="#Trim(Form.ContactPhoneNumber)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.ContactEmailUpdated EQ 1>
							<cfquery name="updateBusinessPhone" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
								Update eCaterers
								Set ContactEmail = <cfqueryparam value="#Trim(Form.ContactEmail)#" cfsqltype="cf_sql_varchar">,
									lastUpdated = #Now()#,
									lastUpdateBy = <cfqueryparam value="#rc.$.currentUser('userName')#" cfsqltype="cf_sql_varchar">
								Where Site_ID = <cfqueryparam value="#rc.$.siteConfig('siteID')#" cfsqltype="cf_sql_varchar"> and
									TContent_ID = <cfqueryparam value="#getSelectedFacility.TContent_ID#" cfsqltype="cf_sql_integer">
						...
						<cfif UpdateInfo.AddressUpdated EQ 0 AND UpdateInfo.CityUpdated EQ 0 AND UpdateInfo.StateUpdated EQ 0 AND UpdateInfo.ZipCodeUpdated EQ 0 AND UpdateInfo.NameUpdated EQ 0 AND UpdateInfo.VoiceNumberUpdated EQ 0 AND UpdateInfo.WebsiteUpdated EQ 0 AND UpdateInfo.PaymentTermsUpdated EQ 0 AND UpdateInfo.DeliveryInfoUpdated EQ 0 AND UpdateInfo.GuaranteeInfoUpdated EQ 0 AND UpdateInfo.AdditionalInfoUpdated EQ 0 AND UpdateInfo.ContactNameUpdated EQ 0 AND UpdateInfo.ContactPhoneUpdated EQ 0 AND UpdateInfo.ContactEmailUpdated EQ 0 AND UpdateInfo.ActiveUpdated EQ 0>
							<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:caterers" addtoken="false">
						<cfelse>
							<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:caterers&UserAction=UpdatedFacility&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
						</cfif>
					</cfcase>
				</cfswitch>
			</cfif>
				...
				<cfswitch expression="#URL.PerformAction#">
					<cfcase value="ReEnterAddress">
						<cflock timeout="60" scope="SESSION" type="Exclusive">
							...
							<cfset Session.UserSuppliedInfo.ContactPhoneNumber = #FORM.ContactPhoneNumber#>
							<cfset Session.UserSuppliedInfo.ContactEmail = #FORM.ContactEmail#>
							<cfset Session.UserSu0ppliedInfo.Active = #FORM.Active#>
						</cflock>
						<cfset UpdateInfo = #StructNew()#>
						<cfquery name="getSelectedFacility" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
