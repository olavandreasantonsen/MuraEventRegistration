...
*/
	...
	variables.framework.packageVersion = '2.005.000';
	...
	variables.framework.suppressImplicitService = true; //true to suppress fw/1 from storing service calls results in rc.data
