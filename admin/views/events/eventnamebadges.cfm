		...
		<cfswitch expression="#FORM.PaperTemplate#">
			<cfcase value="5395">
				...
				<div class="art-block clearfix">
					...
					<div class="art-blockcontent">
						<div class="alert-box notice">Below are the name badges for the registered participants. Click <A href="/plugins/EventRegistration/index.cfm?EventRegistrationaction=admin:events.default" class="art-button">here</a> to return to the listing of available events.<br /><br /> These have  been formatted for Avery 5395 Style Paper.</div>
						<hr>
			...
			<cfdefaultcase>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.eventnamebadges&SiteID=#rc.$.siteConfig('siteID')#" addtoken="false">
			</cfdefaultcase>
		</cfswitch>
	</cfif>
<!--- 877-395-5535 --->
