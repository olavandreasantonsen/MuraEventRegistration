		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif LEN(FORM.Password) OR LEN(FORM.VerifyPassword)>
				<cfif FORM.Password NEQ FORM.VerifyPassword>
					...
					<cflocation addtoken="true" url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:usermenu.editprofile&FormRetry=True">
				<cfelse>
			...
			<cfif Variables.UserEditProfile EQ 1>
				...
				<cflocation addtoken="true" url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:main.default&UserAction=UserProfileUpdated">
			<cfelse>
				<cflocation addtoken="true" url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:main.default">
			</cfif>
