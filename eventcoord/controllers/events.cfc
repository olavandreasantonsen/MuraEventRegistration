	...
	<cffunction name="emailattended" returntype="any" output="true">
		...
		<cfif isDefined("FORM.formSubmit") and isDefined("FORM.PerformAction")>
			...
			<cfif LEN(FORM.EmailMsg) EQ 0>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:events.emailattended&SiteID=#rc.$.siteConfig('siteID')#&EventID=#Session.UserSuppliedInfo.RecNo#" addtoken="false">
			</cfif>
