...
<cfquery name="Create-p_EventRegistration_GradeLevels" datasource="#application.configBean.getDatasource()#" username="#application.configBean.getDBUsername()#" password="#application.configBean.getDBPassword()#">
	CREATE TABLE `p_EventRegistration_GradeLevels` ( `TContent_ID` INT(11) NOT NULL, `Site_ID` TINYTEXT NOT NULL, `GradeLevel` TINYTEXT NOT NULL, `dateCreated` DATETIME NOT NULL DEFAULT '1980-01-01 01:00:00', `lastUpdated` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `lastUpdateBy` VARCHAR(50) NOT NULL DEFAULT '', PRIMARY KEY (`TContent_ID`) ) COLLATE='latin1_swedish_ci' ENGINE=InnoDB AUTO_INCREMENT\1=1;
</cfquery>
