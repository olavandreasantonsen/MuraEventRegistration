...
<cfoutput>
	...
	<h2>Add New Workshop or Event</h2>
	...
	<uForm:form action="" method="Post" id="AddEvent"  errorMessagePlacement="both"
		commonassetsPath="/properties/uniForm/" errors="#Session.FormErrors#"
		showCancel="yes" cancelValue="<--- Return to Menu" cancelName="cancelButton"
		cancelAction="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.addevent&compactDisplay=false"
