									...
									<div id="modelWindowDialog" class="modal fade">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times-circle"></i></button>
													<h3>Event PGP Certificates Sent</h3>
												</div>
												<div class="modal-body">
													<p class="alert alert-success">You have successfully scheduled PGP Certificates to be sent to anyone who has attended the event. Depending on the number of PGP Certificates will depend on how fast they are electronically tramsferred to the participants inbox.</p>
												</div>
												<div class="modal-footer">
													<button class="btn btn-default" data-dismiss="modal" aria-hidden="true">Close</button>
												</div>
						...
						<cfloop query="Session.getAvailableEvents">
							...
							<tr <cfif Session.getAvailableEvents.Active EQ 0></cfif>>
								...
								<td>
									...
									<cfif Session.getSiteConfig.Facebook_Enabled EQ 1><a href="#buildURL('eventcoord:events.publishtofb')#&EventID=#Session.getAvailableEvents.TContent_ID#" class="btn btn-primary btn-small small"><small>Post Facebook</small></a></cfif><br>
