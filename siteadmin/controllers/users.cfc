<cfcomponent output="false" persistent="false" accessors="true">
	...
	<cffunction name="edituser" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Main Menu">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.default" addtoken="false">
			</cfif>
			<cfif FORM.UserAction EQ "Change Password">
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.changepassword" addtoken="false">
			</cfif>
			<cfif FORM.UserAction EQ "Activate Account">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.default&UserAction=ActivatedAccount&Successful=True" addtoken="false">
			</cfif>
			...
			<cfif FORM.InActive EQ "----">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.edituser&FormRetry=True&UserID=#FORM.UserID#" addtoken="false">
			</cfif>
			...
			<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.default&UserAction=AccountUpdated&Successful=True" addtoken="false">
		</cfif>
	</cffunction>
	...
	<cffunction name="changepassword" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Main Menu">
				<cfset temp = StructDelete(Session, "FormErrors")>
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.edituser&UserID=#FORM.UserID#" addtoken="false">
			</cfif>
			<cfif LEN(FORM.Password) LT 5>
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.changepassword&FormRetry=True" addtoken="false">
			</cfif>
			...
			<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.edituser&UserID=#FORM.UserID#&UserAction=PasswordChanged&Successful=True" addtoken="false">
		</cfif>
	</cffunction>
	...
	<cffunction name="adduser" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.InActive EQ "----">
				...
				<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.adduser&FormRetry=True" addtoken="false">
			</cfif>
			<cfif LEN(FORM.Password) LT 5>
				<cfscript>
					errormsg = {property="EmailMsg",message="The Password Field must be longer than 5 characters."};
			...
			<cflocation url="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=siteadmin:users.default&UserAction=AccountCreated&Successful=True" addtoken="false">
		</cfif>
	</cffunction>
