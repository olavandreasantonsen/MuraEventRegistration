...
<cfoutput>
	<div class="art-block clearfix">
		<div class="art-blockheader">
			<h3 class="t">Deactivate Expense Category</h3>
		</div>
		<div class="art-blockcontent">
			<div class="alert-box notice">Please complete the following information to deactivate this expense category.</div>
			<hr>
			<uForm:form action="" method="Post" id="DeActivateExpenses" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				submitValue="Deactivate Expense Category" loadValidation="true" loadMaskUI="true" loadDateUI="false"
				loadTimeUI="false">
