...
<cfoutput>
	<h2>Reviewing new Workshop or Event Entry</h2>
	...
	<uForm:form action="#buildURL('admin:events.addevent_review')#" method="Post" id="AddEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
		...
		<uForm:fieldset legend="Event Date and Time">
			<uform:field label="Primary Event Date <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="EventDate" isDisabled="true" value="#Session.UserSuppliedInfo.EventDate#" type="date" inputClass="date" hint="Date of Event, First Date if event has multiple dates." />
			...
			<uform:field label="Registration Deadline <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="Registration_Deadline" isDisabled="true" value="#Session.UserSuppliedInfo.Registration_Deadline#" type="date" inputClass="date" hint="Accept Registration up to this date" />
			<uform:field label="Registration Start Time <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="Registration_BeginTime" isDisabled="true" value="#Session.UserSuppliedInfo.Registration_BeginTime#" type="time" pluginSetup="#timeConfig#" hint="The Beginning Time onSite Registration begins" />
			<uform:field label="Event Start Time <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="Event_StartTime" isDisabled="true" type="time" value="#Session.UserSuppliedInfo.Event_StartTime#" pluginSetup="#timeConfig#" hint="The starting time of this event" />
			<uform:field label="Event End Time <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="Event_EndTime" isDisabled="true" type="time" value="#Session.UserSuppliedInfo.Event_EndTime#" pluginSetup="#timeConfig#" hint="The ending time of this event" />
		</uForm:fieldset>

		<uForm:fieldset legend="Event Description">
			<uform:field label="Event Short Title <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="ShortTitle" isDisabled="true" value="#Session.UserSuppliedInfo.ShortTitle#" maxFieldLength="50" type="text" hint="Short Event Title of Event" />
			<uform:field label="Event Description <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="LongDescription" isDisabled="true" value="#Session.UserSuppliedInfo.LongDescription#" type="textarea" hint="Description of this meeting or event" />
		</uForm:fieldset>

		<uForm:fieldset legend="Event Details">
			<uform:field label="Event Agenda <a href='#buildURL('admin:events.addevent_step2')#'><i class='icon-wrench'></i></a>" name="EventAgenda" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventAgenda#" hint="The Agenda if avaialble for this event." />
			<uform:field label="Event Target Audience <a href='#buildURL('admin:events.addevent_step2')#'><i class='icon-wrench'></i></a>" name="EventTargetAudience" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventTargetAudience#" hint="The Target Audience for this event. Who should come to this event" />
			<uform:field label="Event Strategies <a href='#buildURL('admin:events.addevent_step2')#'><i class='icon-wrench'></i></a>" name="EventStrategies" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventStrategies#" hint="The Strategies of this event, if any." />
			<uform:field label="Event Special Instructions <a href='#buildURL('admin:events.addevent_step2')#'><i class='icon-wrench'></i></a>" name="EventSpecialInstructions" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventSpecialInstructions#" hint="If available, any special instructions participants need." />
		</uForm:fieldset>
		...
		<cfif Session.UserSuppliedInfo.WebinarEvent EQ 0>
			<uForm:fieldset legend="Event Pricing">
				<uform:field label="Member Pricing <a href='#buildURL('admin:events.addevent_step2')#'><i class='icon-wrench'></i></a>" name="MemberCost" isDisabled="true" type="text" value="#NumberFormat(Session.UserSuppliedInfo.MemberCost, '9999.99')#" hint="The cost for a member school district to attend per person." />
				<uform:field label="NonMember Pricing <a href='#buildURL('admin:events.addevent_step2')#'><i class='icon-wrench'></i></a>" name="NonMemberCost" isDisabled="true" type="text" value="#NumberFormat(Session.UserSuppliedInfo.NonMemberCost, '9999.99')#" hint="The cost for a nonmember school district to attend per person." />
			</uForm:fieldset>
			...
			<uform:field label="Special Pricing Available <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="ViewSpecialPricing" type="text" isDisabled="true" value="#Variables.SpecialPrice_AvailableText#" hint="Does this event have special pricing available?" />
			...
			<uform:field label="EarlyBird Registration Available <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="EarlyBird_RegistrationAvailable" type="text" isDisabled="true" value="#Variables.EarlyBird_AvailableText#" hint="Does this event have an EarlyBird Registration Cutoff Date/Price" />
			...
			<uform:field label="Meal Provided <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="MealProvided" type="text" isDisabled="true" value="#Variables.MealProvided_AvailableText#" hint="Does this event have a meal available to attendee(s)?" />
			...
			<uform:field label="Allow Video Conference <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="AllowVideoConference" isDisabled="true" type="text" value="#Variables.AllowVideoConference_AvailableText#" hint="Can an attendee participate with Video Conference (IP Video)?" />
		...
		<uForm:fieldset legend="Event Featured">
			...
			<uform:field label="Event Featured <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="EventFeatured" type="text" isDisabled="true" value="#Variables.EventFeatured_AvailableText#" hint="Would this event be featured on the website?" />
		...
		<uForm:fieldset legend="Professional Growth Points Information">
			...
			<uform:field label="PGP Points Available <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="PGPAvailable" type="text" isDisabled="true" value="#Variables.PGPAvailable_AvailableText#" hint="Does this event have PGP Points for Attendee(s)?" />
		...
		<uForm:fieldset legend="Event Webinar Information">
			...
			<uform:field label="Allow Webinar Conference <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="WebinarEvent" isDisabled="true" type="text" value="#Variables.WebinarEvent_AvailableText#" hint="Can an attendee participate with Webinar Technology?" />
		...
		<cfif Session.UserSuppliedInfo.WebinarEvent EQ 0>
			...
			<uForm:fieldset legend="Facility Room Information">
				<uform:field label="Facility Location <a href='#buildURL('admin:events.addevent')#'><i class='icon-wrench'></i></a>" name="LocationIDName" isDisabled="true" type="text" value="#GetFacilityInformation.FacilityName#" hint="Where is this facility being held at?" />
