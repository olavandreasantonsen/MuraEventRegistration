...
<cfoutput>
	<div class="art-block clearfix">
		<div class="art-blockheader">
			<h3 class="t">Cancelling Workshop/Event: #Session.UserSuppliedInfo.ShortTitle#</h3>
		</div>
		<div class="art-blockcontent">
			<div class="alert-box notice">Please click the button below to cancel this event and notify everyone who is registered for this event.<br><Strong>Number of Registrations Currently: #Session.EventNumberRegistrations#</Strong></div>
			<hr>
			<uForm:form action="?#HTMLEditFormat(rc.pc.getPackage())#action=admin:events.cancelevent&compactDisplay=false&EventID=#URL.EventID#&EventStatus=CancelEvent" method="Post" id="CancelEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				submitValue="Cancel This Event" loadValidation="true" loadMaskUI="true" loadDateUI="false" loadTimeUI="false">
				...
				<uForm:fieldset legend="Event Meal Information">
					...
					<uform:field label="Meal Provided" name="MealAvailable" type="text" isDisabled="true" value="#Variables.MealProvided_AvailableText#" hint="Does this event have a meal available to attendee(s)?" />
					<uform:field label="Cost Per Person " name="MealCost" isDisabled="true" value="#NumberFormat(Session.UserSuppliedInfo.MealCost, '9999.99')#" type="text" hint="The estimated cost per person for providing this meal." />
					<cfif Session.UserSuppliedInfo.MealAvailable EQ 1>
				...
				<uForm:fieldset legend="Allow Registrations">
					<cfif Session.UserSuppliedInfo.AcceptRegistrations EQ 1><cfset AcceptRegistrations_AvailableText = "Yes"><cfelse><cfset AcceptRegistrations_AvailableText = "No"></cfif>
					<uform:field label="Accept Registrations" name="AcceptRegistrations" isDisabled="true" type="text" value="#Variables.AcceptRegistrations_AvailableText#" hint="Do you want to accept registrations for this event?" />
				</uForm:fieldset>
				<uForm:fieldset legend="Are you Sure?">
					<uform:field label="Accept Registrations" name="CancelEvent" isDisabled="false" type="select" hint="Do you really want to cancel this event?">
						<uform:option display="Yes, Cancel the Event" value="True" isSelected="true" />
						<uform:option display="No, Do not Cancel the Event" value="False" />
					</uform:field>
				</uForm:fieldset>
			</uForm:form>
		</div>
