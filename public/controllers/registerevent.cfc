		...
		<cfif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.formSubmit EQ "true" and FORM.RegisterAdditionalParticipants EQ 0>
				<cfif isDefined("FORM.CancelButton")>
					...
					<cflocation url="/plugins/EventRegistration/index.cfm?EventRegistrationaction=public:events.viewavailableevents&CancelRegistrationSuccessfull=True&SingleRegistration=True" addtoken="false">
